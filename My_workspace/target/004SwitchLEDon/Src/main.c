...
{
	//first turn on Clock
	*pClockControlRegisterAddr = *pClockControlRegisterAddr | 0x08;
	//Turn the mode register to output
	*pGPIODModeRegister = *pGPIODModeRegister | 0x1000000;
	//Finally turn on the LED
	*pGPIODOutputDataRegister = *pGPIODOutputDataRegister | 0x4000;
    /* Loop forever */
	for(;;);
}
